  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Chefkoch: Your Ultimate Dining Experience Awaits! Discover, Reserve, and Savor Exceptional Meals at the Best Restaurants, Just Like Opentable."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to Chefkoch: Your Ultimate Dining Experience Awaits! Discover, Reserve, and Savor Exceptional Meals at the Best Restaurants, Just Like Opentable.`}
            </Text>
